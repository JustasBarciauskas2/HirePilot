import type { JobDetail, JobSizeBand } from "@techrecruit/shared/data/jobs";
import { JOB_SIZE_BAND_LABELS } from "@techrecruit/shared/data/job-types";
import { jobMatchesSalaryRangeK } from "@techrecruit/shared/lib/job-salary-range";
