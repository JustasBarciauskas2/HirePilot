...
import { jobBase } from "@techrecruit/shared/data/job-types";
import type { VacancyNormalizedFromDocument } from "@techrecruit/shared/data/vacancy-normalized-from-document";
import { nextJobRef } from "@techrecruit/shared/lib/create-job-from-input";
import { normalizeSizeBand } from "@techrecruit/shared/lib/merge-vacancy-defaults";
import { inferPayCurrencyFromText, structuredSalaryFromRangeK, type PayCurrency } from "@techrecruit/shared/lib/portal-salary-form";
